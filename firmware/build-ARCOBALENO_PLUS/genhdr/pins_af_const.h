    ...
    { MP_ROM_QSTR(MP_QSTR_AF11_CAN3),      MP_ROM_INT(GPIO_AF11_CAN3) },
#endif
#if defined(MICROPY_HW_UART4_TX)
    { MP_ROM_QSTR(MP_QSTR_AF11_UART4),     MP_ROM_INT(GPIO_AF11_UART4) },
#endif
#if defined(MICROPY_HW_UART5_TX)
    { MP_ROM_QSTR(MP_QSTR_AF11_UART5),     MP_ROM_INT(GPIO_AF11_UART5) },
#endif
    ...
    { MP_ROM_QSTR(MP_QSTR_AF8_CAN1),       MP_ROM_INT(GPIO_AF8_CAN1) },
#endif
#if defined(MICROPY_HW_UART4_TX)
...
#endif
#if defined(MICROPY_HW_UART3_TX)
    { MP_ROM_QSTR(MP_QSTR_AF8_USART3),     MP_ROM_INT(GPIO_AF8_USART3) },
#endif
